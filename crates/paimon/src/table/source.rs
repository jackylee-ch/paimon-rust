...
mod tests {
    ...
    #[test]
    fn data_split_native_round_trip_with_empty_partition() {
        ...
        let java_golden_v8 = [
            ...
            0x66, 0x69, 0x6c, 0x65, 0x3a, 0x2f, 0x74, 0x6d, 0x70, 0x2f, 0x62, 0x75, 0x63, 0x6b,
            0x65, 0x74, 0x2d, 0x30, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        assert_eq!(
            restored.partition().to_serialized_bytes(),
            *crate::spec::EMPTY_SERIALIZED_ROW
        );
        assert_eq!(restored.serialize().expect("reserialize"), bytes);
    }
